...
List of most active GitHub users based on `public contributions` `private contributions` and `number of followers`  by country or state. The list updated `2023/11/11 12:52 AM UTC`.
...
<table>
	...
	<tr>
		...
		<td>
			...
			<code>Manama</code>
   			<code>Sitra</code>
      			<code>Hamad Town</code>
	 		<code>Aali</code>
    			<code>Isa Town</code>
       			<code>Isa Town</code>
	  		<code>Budaiya</code>
     			<code>Jidhafs</code>
			<code>AlMalikiyah</code>
		</td>
	</tr>
	<tr>
		<td>
