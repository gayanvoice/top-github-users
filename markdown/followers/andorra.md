...
The `number of followers` of users in Andorra on `2021/12/23 6:36 PM UTC`. This list contains users from `Andorra` and cities `Andorra-la-vella` `Santa-coloma` `La-margineda` `Engolasters`.
