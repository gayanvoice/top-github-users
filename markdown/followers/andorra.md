...
The `number of followers` of users in Andorra on `2022/6/13 6:41 PM UTC`. This list contains users from `Andorra` and cities `Andorra-la-vella` `Santa-coloma` `La-margineda` `Engolasters`.
