...
The `number of followers` of users in Finland on `2024/6/15 12:35 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
