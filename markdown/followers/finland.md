...
The `number of followers` of users in Finland on `2023/12/25 12:17 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
