...
The `number of followers` of users in Finland on `2022/5/12 1:19 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
