...
The `number of followers` of users in Finland on `2024/7/20 12:58 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/elliotl105">elliotl105</a></td>
		<td>Finland RN</td>
		<td>199</td>
	</tr>
	<tr>
