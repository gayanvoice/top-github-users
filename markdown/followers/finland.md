...
The `number of followers` of users in Finland on `2022/2/27 6:24 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
