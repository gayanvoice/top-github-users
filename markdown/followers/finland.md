...
The `number of followers` of users in Finland on `2022/5/1 1:18 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
