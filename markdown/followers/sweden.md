...
The `number of followers` of users in Sweden on `2021/6/15 6:30 AM UTC`. This list contains users from `Sweden` and cities `Stockholm` `Gothenburg` `Uppsala` `Helsingborg`.
