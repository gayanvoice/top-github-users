...
The `number of followers` of users in Lithuania on `2022/3/10 7:15 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
