...
The `number of followers` of users in Albania on `2021/8/23 12:34 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/mateokurti">
				<img src="https://avatars.githubusercontent.com/u/29175219?s=72&v=4" width="24" alt="Avatar of mateokurti"> mateokurti
			</a><br/>
			Mateo Kurti
		</td>
		<td>Grid Coding </td>
