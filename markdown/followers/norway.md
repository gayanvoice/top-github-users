...
The `number of followers` of users in Norway on `2021/9/13 11:22 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

There are `137 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `1000 users`  in Norway. You need at least `26 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>983</td>
		<td>
			<a href="https://github.com/halvorboe">
				<img src="https://avatars.githubusercontent.com/u/19977186?s=72&u=f3e07caf263c992c6702cc3da984b1219c51b17b&v=4" width="24" alt="Avatar of halvorboe"> halvorboe
			</a><br/>
			Halvor Fladsrud Bø
		</td>
		<td>@palantir </td>
