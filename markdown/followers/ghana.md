...
The `number of followers` of users in Ghana on `2026/9/1 3:21 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
...
<table>
	...
	<tr>
		...
		<td><a href="https://twitter.com/wksusuassey">wksusuassey</a></td>
		<td>Ghana</td>
		<td>91</td>
	</tr>
	<tr>
