...
The `number of followers` of users in Belgium on `2021/11/19 3:26 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
...
<table>
	...
	<tr>
		...
		<td>Open Source Consultant @inuits.eu<br/></td>
		<td>No Twitter Username</td>
		<td>Belgium</td>
		<td>28</td>
	</tr>
