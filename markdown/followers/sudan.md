...
The `number of followers` of users in Sudan on `2021/6/15 6:23 AM UTC`. This list contains users from `Sudan` and cities `Khartoum` `Omdurman`.

There are `136 countries` and `685 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `200 users`  in Sudan. You need at least `2 followers` to be on this list.
