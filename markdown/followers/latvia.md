...
The `number of followers` of users in Latvia on `2022/4/10 12:58 PM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
...
<table>
	...
	<tr>
		<td>995</td>
		<td>
			<a href="https://github.com/henjin">
				<img src="https://avatars.githubusercontent.com/u/999820?s=72&v=4" width="24" alt="Avatar of henjin"> henjin
			</a><br/>
			Jānis Vītiņš
		</td>
		<td>Mak It, Sia </td>
