...
The `number of followers` of users in Iraq on `2022/2/28 6:20 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
...
<table>
	...
	<tr>
		...
		<td>American University Of Iraq<br/>-<br/>Baghdad<br/></td>
