...
The `number of followers` of users in Ireland on `2022/4/20 12:39 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.
