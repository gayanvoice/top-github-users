...
The `number of followers` of users in Ireland on `2022/6/18 7:07 AM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.
