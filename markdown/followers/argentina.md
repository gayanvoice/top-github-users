...
The `number of followers` of users in Argentina on `2022/4/16 7:01 AM UTC`. This list contains users from `Argentina` and cities `Buenos-aires` `Cordoba` `Rosario` `La-plata` `Tucumán` `Mar-del-plata` `Salta` `Santa-fe`.
...
<table>
	...
	<tr>
		...
		<td>Backend Engineer At @deptagency<br/></td>
		<td>No Twitter Username</td>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/jd-apprentice">
				<img src="https://avatars.githubusercontent.com/u/68082746?s=72&u=26db5a5bb802e13cc726273b8a4f9fb1931df85d&v=4" width="24" alt="Avatar of jd-apprentice"> jd-apprentice
			</a><br/>
			Jonathan Dyallo
		</td>
		<td>Incubator </td>
