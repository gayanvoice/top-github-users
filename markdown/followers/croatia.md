...
The `number of followers` of users in Croatia on `2021/10/10 1:00 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/franjurinec">franjurinec</a></td>
		<td>Zagreb, Croatia</td>
		<td>6</td>
	</tr>
	<tr>
