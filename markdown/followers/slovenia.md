...
The `number of followers` of users in Slovenia on `2021/10/25 9:28 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
