...
The `number of followers` of users in Peru on `2025/11/21 12:23 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
