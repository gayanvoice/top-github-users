...
The `number of followers` of users in Peru on `2025/10/4 1:43 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
