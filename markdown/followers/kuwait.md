...
The `number of followers` of users in Kuwait on `2023/11/26 12:17 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
