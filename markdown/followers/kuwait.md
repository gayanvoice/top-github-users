...
The `number of followers` of users in Kuwait on `2024/6/20 1:25 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
