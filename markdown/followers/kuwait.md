...
The `number of followers` of users in Kuwait on `2023/8/14 12:49 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
