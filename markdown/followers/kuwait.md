...
The `number of followers` of users in Kuwait on `2021/6/16 10:53 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
