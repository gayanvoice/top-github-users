...
The `number of followers` of users in Kuwait on `2024/2/3 12:16 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
