...
The `number of followers` of users in Saudi Arabia on `2024/11/23 1:06 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
