...
The `number of followers` of users in Saudi Arabia on `2022/5/30 7:09 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
...
<table>
	...
	<tr>
		...
		<td>Cma </td>
		<td><a href="https://twitter.com/BanGinu1337">BanGinu1337</a></td>
		<td>Riyadh</td>
		<td>3</td>
	</tr>
	<tr>
