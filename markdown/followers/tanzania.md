...
The `number of followers` of users in Tanzania on `2023/11/5 12:54 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
