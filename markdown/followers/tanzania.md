...
The `number of followers` of users in Tanzania on `2025/10/12 1:13 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
