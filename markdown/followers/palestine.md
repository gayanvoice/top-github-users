...
The `number of followers` of users in Palestine on `2024/5/24 12:55 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
