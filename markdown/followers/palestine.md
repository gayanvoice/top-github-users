...
The `number of followers` of users in Palestine on `2025/7/4 12:22 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
