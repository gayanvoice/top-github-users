...
The `number of followers` of users in Palestine on `2024/6/28 12:17 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
