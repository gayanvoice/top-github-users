...
The `number of followers` of users in India on `2021/6/12 11:10 AM UTC`. This list contains users from `India` and cities `Mumbai` `Delhi` `Kolkata` `Hyderabad` `Bangalore` `Chennai`.
