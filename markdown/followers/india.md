...
The `number of followers` of users in India on `2021/6/11 12:14 PM UTC`. This list contains users from `India` and cities `Mumbai` `Delhi` `Kolkata` `Hyderabad` `Bangalore` `Chennai`.
