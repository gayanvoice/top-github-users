...
The `number of followers` of users in Rwanda on `2021/6/15 5:35 AM UTC`. This list contains users from `Rwanda` and cities `Kigali`.

There are `136 countries` and `685 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `200 users`  in Rwanda. You need at least `7 followers` to be on this list.
