...
The `number of followers` of users in United Arab Emirates on `2024/10/21 1:00 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
