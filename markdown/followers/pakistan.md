...
The `number of followers` of users in Pakistan on `2021/6/16 11:02 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
