...
The `number of followers` of users in Pakistan on `2026/6/20 1:39 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
