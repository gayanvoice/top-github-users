...
The `number of followers` of users in Mozambique  on `2024/6/25 12:33 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
