...
The `number of followers` of users in Mozambique  on `2024/10/9 1:39 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
