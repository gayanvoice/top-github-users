...
The `number of followers` of users in Mozambique  on `2021/7/11 9:17 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
