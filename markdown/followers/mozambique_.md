...
The `number of followers` of users in Mozambique  on `2021/7/17 1:22 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
