...
The `number of followers` of users in Mozambique  on `2022/4/1 6:44 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
