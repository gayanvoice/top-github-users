...
The `number of followers` of users in Mozambique  on `2025/3/19 12:42 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
