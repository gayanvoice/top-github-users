...
The `number of followers` of users in Mozambique  on `2024/3/13 12:16 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
