...
The `number of followers` of users in Mozambique  on `2021/12/8 6:56 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
