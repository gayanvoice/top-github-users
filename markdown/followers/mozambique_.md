...
The `number of followers` of users in Mozambique  on `2021/12/30 7:08 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
