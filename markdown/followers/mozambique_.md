...
The `number of followers` of users in Mozambique  on `2021/11/22 2:40 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
