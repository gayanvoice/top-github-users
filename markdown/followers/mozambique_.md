...
The `number of followers` of users in Mozambique  on `2022/4/11 6:19 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
