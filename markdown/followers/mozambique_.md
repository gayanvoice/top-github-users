...
The `number of followers` of users in Mozambique  on `2021/8/26 10:19 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
