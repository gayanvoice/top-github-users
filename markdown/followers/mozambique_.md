...
The `number of followers` of users in Mozambique  on `2021/9/13 3:19 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
