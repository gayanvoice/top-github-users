...
The `number of followers` of users in Mozambique  on `2024/9/3 12:36 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
