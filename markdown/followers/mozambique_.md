...
The `number of followers` of users in Mozambique  on `2022/1/20 7:10 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
