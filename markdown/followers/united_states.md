...
The `number of followers` of users in United States on `2021/12/5 4:34 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `1000 users`  in United States. You need at least `387 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/zricethezav">
				<img src="https://avatars.githubusercontent.com/u/15034943?s=72&u=83eb194ecbade41917eaeb4a700e0af2727880e2&v=4" width="24" alt="Avatar of zricethezav"> zricethezav
			</a><br/>
			Zachary Rice
		</td>
		<td>@gitlab </td>
		<td><a href="https://twitter.com/zricethezav">zricethezav</a></td>
		<td>Chicago, IL</td>
		<td>586</td>
	</tr>
	<tr>
