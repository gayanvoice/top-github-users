...
The `number of followers` of users in United States on `2022/1/24 12:26 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `1000 users`  in United States. You need at least `389 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>997</td>
		<td>
			<a href="https://github.com/zalo">
				<img src="https://avatars.githubusercontent.com/u/174475?s=72&v=4" width="24" alt="Avatar of zalo"> zalo
			</a><br/>
			Johnathon Selstad
		</td>
		<td>@leapmotion </td>
		<td><a href="https://twitter.com/makeshifted">makeshifted</a></td>
		<td>San Francisco</td>
		<td>390</td>
	</tr>
	<tr>
