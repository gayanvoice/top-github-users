...
The `number of followers` of users in United States on `2024/10/22 12:46 AM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `899 users`  in United States. You need at least `559 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>Seniot Ml Scientist @sap<br/></td>
