...
The `number of followers` of users in Kazakhstan on `2024/8/29 12:19 AM UTC`. This list contains users from `Kazakhstan` and cities `Almaty` `Shymkent` `Karagandy` `Taraz` `Nursultan` `Pavlodar` `Oskemen` `Semey` `Aktobe` `Kostanay`.
...
<table>
	...
	<tr>
		<td>912</td>
		<td>
			<a href="https://github.com/k1mst0n">
				<img src="https://avatars.githubusercontent.com/u/3992875?s=72&v=4" width="24" alt="Avatar of k1mst0n"> k1mst0n
			</a><br/>
			Kim Ivanov
		</td>
		<td>Drivee </td>
