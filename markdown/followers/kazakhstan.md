...
The `number of followers` of users in Kazakhstan on `2025/6/23 1:20 AM UTC`. This list contains users from `Kazakhstan` and cities `Almaty` `Shymkent` `Karagandy` `Taraz` `Nursultan` `Pavlodar` `Oskemen` `Semey` `Aktobe` `Kostanay`.
...
<table>
	...
	<tr>
		<td>950</td>
		<td>
			<a href="https://github.com/mustaqbal-dev">
				<img src="https://avatars.githubusercontent.com/u/4972562?s=72&u=ab3109f3d406262701d1f7b8251a4eef5fad15ec&v=4" width="24" alt="Avatar of mustaqbal-dev"> mustaqbal-dev
			</a><br/>
			Arman Mukatov
		</td>
		<td>No Company</td>
