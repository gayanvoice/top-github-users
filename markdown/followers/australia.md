...
The `number of followers` of users in Australia on `2021/9/4 5:23 AM UTC`. This list contains users from `Australia` and cities `Sydney` `Melbourne` `Perth` `Adelaide` `Brisbane` `Canberra` `Hobart` `Gold-coast` `Darwin`.
...
<table>
	...
	<tr>
		<td>998</td>
		<td>
			<a href="https://github.com/R4ndall">
				<img src="https://avatars.githubusercontent.com/u/8018841?s=72&u=67e236452b544125c12746d9e31f75a8f4bd9a88&v=4" width="24" alt="Avatar of R4ndall"> R4ndall
			</a><br/>
			Thomas Randall
		</td>
		<td>No Company</td>
