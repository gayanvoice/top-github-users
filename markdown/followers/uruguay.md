...
The `number of followers` of users in Uruguay on `2021/6/15 7:52 AM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.

There are `136 countries` and `685 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `200 users`  in Uruguay. You need at least `18 followers` to be on this list.
