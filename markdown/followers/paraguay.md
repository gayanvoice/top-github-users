...
The `number of followers` of users in Paraguay on `2021/6/15 5:05 AM UTC`. This list contains users from `Paraguay` and cities `Asunción ` `Ciudad-del-este` `Encarnacion` `Luque-paraguay`.
