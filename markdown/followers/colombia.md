...
The `number of followers` of users in Colombia on `2025/7/28 1:25 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
