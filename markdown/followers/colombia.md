...
The `number of followers` of users in Colombia on `2024/6/12 12:18 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
