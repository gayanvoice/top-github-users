...
The `number of followers` of users in Colombia on `2025/3/2 12:45 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
