...
The `number of followers` of users in Colombia on `2022/6/16 6:23 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
