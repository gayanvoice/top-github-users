...
The `number of followers` of users in Colombia on `2024/4/3 12:32 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
