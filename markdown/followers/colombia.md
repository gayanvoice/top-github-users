...
The `number of followers` of users in Colombia on `2023/9/9 12:30 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
