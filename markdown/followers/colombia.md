...
The `number of followers` of users in Colombia on `2026/8/20 2:23 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
