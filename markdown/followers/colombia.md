...
The `number of followers` of users in Colombia on `2024/11/1 1:11 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
