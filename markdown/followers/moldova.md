...
The `number of followers` of users in Moldova on `2021/7/23 5:20 AM UTC`. This list contains users from `Moldova` and cities `Chișinău` `Tiraspol`.
