...
The `number of followers` of users in Moldova on `2021/11/10 10:30 AM UTC`. This list contains users from `Moldova` and cities `Chișinău` `Tiraspol`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `991 users`  in Moldova. You need at least `0 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/ArteomBalanuta">
				<img src="https://avatars.githubusercontent.com/u/49981836?s=72&v=4" width="24" alt="Avatar of ArteomBalanuta"> ArteomBalanuta
			</a><br/>
			Artyom Balanuta
		</td>
		<td>No Company</td>
