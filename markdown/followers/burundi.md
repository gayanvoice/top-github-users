...
The `number of followers` of users in Burundi on `2021/12/6 11:18 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
