...
The `number of followers` of users in Burundi on `2025/6/9 12:45 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/linkiratanga">linkiratanga</a></td>
		<td>Burundi</td>
		<td>3</td>
	</tr>
	<tr>
