...
The `number of followers` of users in Burundi on `2022/1/16 12:40 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
