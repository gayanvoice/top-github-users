...
The `number of followers` of users in Burundi on `2021/8/18 1:27 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
