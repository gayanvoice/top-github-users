...
The `number of followers` of users in Burundi on `2021/9/27 9:13 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
