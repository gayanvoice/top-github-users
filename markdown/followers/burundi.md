...
The `number of followers` of users in Burundi on `2021/12/14 1:12 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
