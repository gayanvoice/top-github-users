...
The `number of followers` of users in Burundi on `2025/7/25 1:15 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
