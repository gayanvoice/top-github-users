...
The `number of followers` of users in Taiwan on `2023/10/13 12:53 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
