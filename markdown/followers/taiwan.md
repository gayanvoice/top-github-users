...
The `number of followers` of users in Taiwan on `2023/12/21 12:54 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
