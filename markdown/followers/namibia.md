...
The `number of followers` of users in Namibia on `2021/9/30 1:24 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
