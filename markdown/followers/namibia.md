...
The `number of followers` of users in Namibia on `2022/2/10 1:47 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `499 users`  in Namibia. You need at least `0 followers` to be on this list.
