...
The `number of followers` of users in Namibia on `2021/10/30 12:51 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
