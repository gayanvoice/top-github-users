...
The `number of followers` of users in Namibia on `2021/6/18 2:36 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
