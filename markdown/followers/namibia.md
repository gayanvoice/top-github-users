...
The `number of followers` of users in Namibia on `2021/6/29 4:29 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
