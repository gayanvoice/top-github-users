...
The `number of followers` of users in Namibia on `2021/11/10 4:29 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
