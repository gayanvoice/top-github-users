...
The `number of followers` of users in Namibia on `2021/11/27 11:24 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
