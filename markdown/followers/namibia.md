...
The `number of followers` of users in Namibia on `2022/4/1 7:11 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
