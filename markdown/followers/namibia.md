...
The `number of followers` of users in Namibia on `2021/10/12 7:18 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
