...
The `number of followers` of users in Namibia on `2021/9/19 12:53 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
