...
The `number of followers` of users in South Korea on `2024/9/11 12:39 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
...
<table>
	...
	<tr>
		...
		<td>@snucse, Ex @portone-io Vpe,<br/>@contentstech-com<br/>Vpe<br/></td>
