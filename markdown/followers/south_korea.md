...
The `number of followers` of users in South Korea on `2024/5/29 12:59 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
...
<table>
	...
	<tr>
		...
		<td>@sionic-ai @instructkr Gopher, Ml<br/>&<br/>Infra<br/>Newbie.<br/></td>
	...
	<tr>
		...
		<td>Bemyfriends @dndacademy @mbti-nf-team @sipe-team<br/></td>
		<td>No Twitter Username</td>
		<td>Seoul, South Korea</td>
		<td>142</td>
	</tr>
	...
	<tr>
		<td>965</td>
		<td>
			<a href="https://github.com/yunchaehyun">
		...
		<td>@wrtn-technologies @boostcampwm2023 </td>
		<td>No Twitter Username</td>
		<td>Seoul, Korea</td>
		<td>92</td>
	</tr>
