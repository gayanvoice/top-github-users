...
The `number of followers` of users in Switzerland on `2022/12/18 1:01 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
