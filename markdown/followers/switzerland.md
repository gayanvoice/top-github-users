...
The `number of followers` of users in Switzerland on `2025/10/12 12:24 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
