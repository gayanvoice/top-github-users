...
The `number of followers` of users in Switzerland on `2023/11/5 12:18 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
...
<table>
	...
	<tr>
		...
		<td>Eth Zürich </td>
		<td><a href="https://twitter.com/larsgebraad">larsgebraad</a></td>
		<td>Switzerland</td>
		<td>74</td>
	</tr>
	<tr>
