...
The `number of followers` of users in Switzerland on `2024/3/22 12:17 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
