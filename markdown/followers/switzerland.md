...
The `number of followers` of users in Switzerland on `2022/8/19 1:17 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
