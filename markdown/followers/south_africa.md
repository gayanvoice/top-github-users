...
The `number of followers` of users in South Africa on `2023/7/23 12:37 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
...
<table>
	...
	<tr>
		...
		<td>Stitch </td>
		<td><a href="https://twitter.com/hendrikdelarey">hendrikdelarey</a></td>
		<td>Cape Town, South Africa</td>
		<td>13</td>
	</tr>
	<tr>
