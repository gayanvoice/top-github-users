...
The `number of followers` of users in Russia on `2022/4/13 6:49 AM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
...
<table>
	...
	<tr>
		<td>999</td>
		<td>
			<a href="https://github.com/empathy87">
				<img src="https://avatars.githubusercontent.com/u/31715230?s=72&u=dcf8d5c3fa81ec19314672c5669e7fad3f0b7136&v=4" width="24" alt="Avatar of empathy87"> empathy87
			</a><br/>
			Andrey Gaskov
		</td>
		<td>No Company</td>
