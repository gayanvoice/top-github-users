...
The `number of followers` of users in Kenya on `2024/11/11 12:23 AM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
