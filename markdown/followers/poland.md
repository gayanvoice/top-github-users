...
The `number of followers` of users in Poland on `2022/3/23 6:18 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
