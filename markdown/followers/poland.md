...
The `number of followers` of users in Poland on `2021/10/30 2:25 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
