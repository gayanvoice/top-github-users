...
The `number of followers` of users in Poland on `2021/9/25 9:27 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
