...
The `number of followers` of users in Poland on `2021/6/17 1:39 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
