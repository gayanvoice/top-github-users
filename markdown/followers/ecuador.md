...
The `number of followers` of users in Ecuador on `2021/10/16 6:25 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
