...
The `number of followers` of users in Ecuador on `2021/11/8 5:29 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
...
<table>
	...
	<tr>
		<td>994</td>
		<td>
			<a href="https://github.com/chavomacias">
				<img src="https://avatars.githubusercontent.com/u/42943528?s=72&u=1952c8f2b6b39b858829b531bc0f0d0d07d4ccd4&v=4" width="24" alt="Avatar of chavomacias"> chavomacias
			</a><br/>
			Nel Macías
		</td>
		<td>Consultoría Nel Macías </td>
		<td>No Twitter Username</td>
		<td>Ecuador - Manabí - Calceta</td>
		<td>2</td>
	</tr>
	<tr>
		<td>995</td>
