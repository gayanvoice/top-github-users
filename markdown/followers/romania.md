...
The `number of followers` of users in Romania on `2022/6/22 6:23 AM UTC`. This list contains users from `Romania` and cities `Bucharest` `Constanța`.
