...
The `number of followers` of users in Venezuela on `2022/6/1 6:49 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
