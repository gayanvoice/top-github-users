...
The `number of followers` of users in Venezuela on `2022/3/25 6:21 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
