...
The `number of followers` of users in Venezuela on `2024/4/29 12:54 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
