...
The `number of followers` of users in Venezuela on `2021/6/15 8:29 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
