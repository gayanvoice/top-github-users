...
The `number of followers` of users in Botswana on `2021/12/24 6:53 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
