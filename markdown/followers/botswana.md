...
The `number of followers` of users in Botswana on `2026/8/9 1:23 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
