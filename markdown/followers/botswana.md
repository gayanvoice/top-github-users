...
The `number of followers` of users in Botswana on `2021/10/3 1:21 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
