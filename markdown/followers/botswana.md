...
The `number of followers` of users in Botswana on `2021/8/12 5:22 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
