...
The `number of followers` of users in Botswana on `2021/9/4 4:24 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
