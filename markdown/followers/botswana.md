...
The `number of followers` of users in Botswana on `2026/5/13 12:43 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
