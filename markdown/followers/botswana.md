...
The `number of followers` of users in Botswana on `2025/12/10 1:17 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
