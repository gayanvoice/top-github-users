...
The `number of followers` of users in Botswana on `2021/6/15 2:56 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
