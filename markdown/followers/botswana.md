...
The `number of followers` of users in Botswana on `2021/7/26 9:27 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
