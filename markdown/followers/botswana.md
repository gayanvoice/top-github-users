...
The `number of followers` of users in Botswana on `2025/2/26 12:18 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
