...
The `number of followers` of users in Botswana on `2024/7/13 12:33 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
