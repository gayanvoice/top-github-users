...
The `number of followers` of users in Botswana on `2024/6/8 1:25 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
