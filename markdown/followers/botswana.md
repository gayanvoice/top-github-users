...
The `number of followers` of users in Botswana on `2021/11/7 8:18 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
