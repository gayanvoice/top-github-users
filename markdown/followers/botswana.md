...
The `number of followers` of users in Botswana on `2021/8/24 5:15 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
