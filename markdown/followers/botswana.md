...
The `number of followers` of users in Botswana on `2021/12/14 7:01 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
