...
The `number of followers` of users in Botswana on `2022/1/15 6:15 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/GovanLegacy01">GovanLegacy01</a></td>
		<td>Botswana</td>
		<td>1</td>
	</tr>
	<tr>
