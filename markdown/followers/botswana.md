...
The `number of followers` of users in Botswana on `2022/5/10 6:44 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
