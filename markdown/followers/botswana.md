...
The `number of followers` of users in Botswana on `2022/6/15 1:04 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
