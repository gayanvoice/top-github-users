...
The `number of followers` of users in Belarus on `2022/1/15 6:46 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
