...
The `number of followers` of users in Belarus on `2025/1/17 12:40 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
