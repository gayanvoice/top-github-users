...
The `number of followers` of users in Belarus on `2021/12/13 7:18 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
