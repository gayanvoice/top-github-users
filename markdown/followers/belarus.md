...
The `number of followers` of users in Belarus on `2022/6/14 1:11 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
