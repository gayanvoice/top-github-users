...
The `number of followers` of users in Belarus on `2025/12/8 1:18 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
