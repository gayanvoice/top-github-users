...
The `number of followers` of users in Bhutan on `2021/11/1 7:19 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.
