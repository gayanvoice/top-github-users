...
The `number of followers` of users in Bhutan on `2021/8/18 6:20 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.
