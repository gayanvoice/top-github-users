...
The `number of followers` of users in Bhutan on `2021/7/3 8:17 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.
