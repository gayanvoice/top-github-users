...
The `number of followers` of users in Bhutan on `2022/2/4 7:12 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.
