...
The `number of followers` of users in Bhutan on `2021/8/1 2:06 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.
