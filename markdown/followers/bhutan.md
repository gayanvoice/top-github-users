...
The `number of followers` of users in Bhutan on `2021/6/15 2:05 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.
