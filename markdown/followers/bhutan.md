...
The `number of followers` of users in Bhutan on `2022/6/14 6:54 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.
