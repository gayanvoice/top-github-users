...
The `number of followers` of users in Hungary on `2022/6/6 7:02 AM UTC`. This list contains users from `Hungary` and cities `Budapest` `Debrecen` `Szeged` `Miskolc` `Pécs` `Győr`.
...
<table>
	...
	<tr>
		<td>964</td>
		<td>
			<a href="https://github.com/devbence">
				<img src="https://avatars.githubusercontent.com/u/936368?s=72&v=4" width="24" alt="Avatar of devbence"> devbence
			</a><br/>
			devbence
		</td>
		<td>Gbence.com </td>
		<td><a href="https://twitter.com/devbence">devbence</a></td>
		<td>Hungary</td>
		<td>12</td>
	</tr>
	<tr>
