...
The `number of followers` of users in El Salvador on `2021/9/22 9:19 PM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.
