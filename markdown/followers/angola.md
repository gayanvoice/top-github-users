...
The `number of followers` of users in Angola on `2026/7/26 2:28 AM UTC`. This list contains users from `Angola` and cities `Luanda` `Cabinda ` `Huambo` `Lubango ` `Kuito` `Malanje ` `Lobito` `Benguela`.
...
<table>
	...
	<tr>
		<td>952</td>
		<td>
			<a href="https://github.com/makitub">
				<img src="https://avatars.githubusercontent.com/u/66423500?s=72&v=4" width="24" alt="Avatar of makitub"> makitub
			</a><br/>
			Aristofenes Paulo Gonfulo
		</td>
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>Angola</td>
