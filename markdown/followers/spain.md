...
The `number of followers` of users in Spain on `2022/1/1 7:23 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
