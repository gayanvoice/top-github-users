...
The `number of followers` of users in Spain on `2022/4/14 6:45 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
