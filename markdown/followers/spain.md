...
The `number of followers` of users in Spain on `2021/10/7 4:35 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
