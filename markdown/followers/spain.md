...
The `number of followers` of users in Spain on `2022/5/31 6:20 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
