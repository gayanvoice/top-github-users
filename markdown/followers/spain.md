...
The `number of followers` of users in Spain on `2022/2/22 7:14 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
