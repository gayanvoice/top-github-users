...
The `number of followers` of users in Azerbaijan on `2022/9/15 1:30 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
