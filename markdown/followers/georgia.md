...
The `number of followers` of users in Georgia on `2021/11/20 12:30 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
