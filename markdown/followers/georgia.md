...
The `number of followers` of users in Georgia on `2021/10/22 12:31 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
