...
The `number of followers` of users in Georgia on `2023/12/25 12:55 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
