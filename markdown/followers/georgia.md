...
The `number of followers` of users in Georgia on `2022/3/19 6:56 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
...
<table>
	...
	<tr>
		<td>896</td>
		<td>
			<a href="https://github.com/mlagutko">
				<img src="https://avatars.githubusercontent.com/u/157628?s=72&v=4" width="24" alt="Avatar of mlagutko"> mlagutko
			</a><br/>
			Michael Lagutko
		</td>
		<td>N-brain </td>
