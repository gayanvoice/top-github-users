...
The `number of followers` of users in Mauritania on `2021/10/6 12:53 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
