...
The `number of followers` of users in Mauritania on `2022/5/3 6:59 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
