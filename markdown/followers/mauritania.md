...
The `number of followers` of users in Mauritania on `2021/12/8 2:13 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
