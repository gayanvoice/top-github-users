...
The `number of followers` of users in Mauritania on `2021/12/29 6:59 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
