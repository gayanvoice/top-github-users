...
The `number of followers` of users in Mauritania on `2022/1/30 1:01 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
