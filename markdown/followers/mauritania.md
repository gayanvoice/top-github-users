...
The `number of followers` of users in Mauritania on `2024/11/14 12:14 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
