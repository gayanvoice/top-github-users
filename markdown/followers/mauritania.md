...
The `number of followers` of users in Mauritania on `2021/7/23 2:01 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
