...
The `number of followers` of users in Mauritania on `2022/4/21 7:08 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
