...
The `number of followers` of users in Mauritania on `2022/3/11 12:18 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
