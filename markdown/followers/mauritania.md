...
The `number of followers` of users in Mauritania on `2024/2/5 1:17 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
