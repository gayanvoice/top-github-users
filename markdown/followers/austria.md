...
The `number of followers` of users in Austria on `2021/8/17 11:23 PM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.
...
<table>
	...
	<tr>
		<td>999</td>
		<td>
			<a href="https://github.com/flipflopsimsommer">
				<img src="https://avatars.githubusercontent.com/u/2880362?s=72&v=4" width="24" alt="Avatar of flipflopsimsommer"> flipflopsimsommer
			</a><br/>
			Clemo
		</td>
		<td>No Company</td>
