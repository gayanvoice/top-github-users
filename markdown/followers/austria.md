...
The `number of followers` of users in Austria on `2021/6/21 12:56 AM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/schneelittchen">
				<img src="https://avatars.githubusercontent.com/u/83172201?s=72&u=f23c1c2bcfd8340f214c9d640dab8542dd91db5e&v=4" width="24" alt="Avatar of schneelittchen"> schneelittchen
			</a><br/>
			alexandra
		</td>
		<td>No Company</td>
