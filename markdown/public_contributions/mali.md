...
The `public contributions` by users in Mali on `2021/12/18 6:51 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `239 users`  in Mali. You need at least `0 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td><a href="https://twitter.com/alisariyer">alisariyer</a></td>
		<td>Bamako</td>
		<td>37</td>
	</tr>
	<tr>
	...
	<tr>
		<td>88</td>
		<td>
			<a href="https://github.com/1xbetthaiscom">
				<img src="https://avatars.githubusercontent.com/u/96160160?s=72&v=4" width="24" alt="Avatar of 1xbetthaiscom"> 1xbetthaiscom
			</a><br/>
			1xbet Thai
		</td>
		<td>No Company</td>
		<td><a href="https://twitter.com/1xbetthaiscom">1xbetthaiscom</a></td>
		<td>99 Soi Suan Mali 3, Khwaeng Wat Thepsirin, Khet Pom Prap Satru Phai, Bangkok 10100 Thái Lan</td>
		<td>1</td>
	</tr>
	<tr>
		<td>89</td>
