...
The `public contributions` by users in Norway on `2021/11/22 10:32 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
