...
The `public contributions` by users in Albania on `2022/6/25 6:42 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/arberLisaj">
				<img src="https://avatars.githubusercontent.com/u/105673782?s=72&u=ba2d6ed737d3ccd2d80ac5a00ee8a14ae1ee3e20&v=4" width="24" alt="Avatar of arberLisaj"> arberLisaj
			</a><br/>
			Arber Lisaj
		</td>
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>Lushnje , Albania</td>
		<td>5</td>
	</tr>
	<tr>
		<td>358</td>
