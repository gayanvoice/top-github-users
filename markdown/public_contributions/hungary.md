...
The `public contributions` by users in Hungary on `2021/10/22 6:27 PM UTC`. This list contains users from `Hungary` and cities `Budapest` `Debrecen` `Szeged` `Miskolc` `Pécs` `Győr`.
...
<table>
	...
	<tr>
		...
		<td> @internet-of-people @paritytech </td>
		<td>No Twitter Username</td>
		<td>Budapest, Hungary</td>
		<td>70</td>
	</tr>
	...
	<tr>
		<td>871</td>
		<td>
			<a href="https://github.com/zilahu">
				<img src="https://avatars.githubusercontent.com/u/266398?s=72&v=4" width="24" alt="Avatar of zilahu"> zilahu
			</a><br/>
			No Name
		</td>
		<td>No Company</td>
