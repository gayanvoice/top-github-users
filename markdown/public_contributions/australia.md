...
The `public contributions` by users in Australia on `2021/11/1 11:26 AM UTC`. This list contains users from `Australia` and cities `Sydney` `Melbourne` `Perth` `Adelaide` `Brisbane` `Canberra` `Hobart` `Gold-coast` `Darwin`.
...
<table>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/cjrh">
				<img src="https://avatars.githubusercontent.com/u/480395?s=72&u=0282ce6f88de302b60c6b7cff58f7437db7b5eab&v=4" width="24" alt="Avatar of cjrh"> cjrh
			</a><br/>
			Caleb Hattingh
		</td>
		<td>No Company</td>
	...
	<tr>
		...
		<td>@mfractor </td>
		<td><a href="https://twitter.com/matthewrdev">matthewrdev</a></td>
		<td>Brisbane, Australia</td>
		<td>83</td>
	</tr>
	<tr>
