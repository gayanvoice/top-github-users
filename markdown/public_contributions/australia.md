...
The `public contributions` by users in Australia on `2021/11/30 10:30 AM UTC`. This list contains users from `Australia` and cities `Sydney` `Melbourne` `Perth` `Adelaide` `Brisbane` `Canberra` `Hobart` `Gold-coast` `Darwin`.
...
<table>
	...
	<tr>
		<td>402</td>
		<td>
			<a href="https://github.com/kenbot">
				<img src="https://avatars.githubusercontent.com/u/316515?s=72&u=a6eb620893975ff93069d2eba987ca11f6bcdd69&v=4" width="24" alt="Avatar of kenbot"> kenbot
			</a><br/>
			Ken Scambler
		</td>
		<td>No Company</td>
