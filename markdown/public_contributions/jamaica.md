...
The `public contributions` by users in Jamaica on `2022/3/30 1:08 PM UTC`. This list contains users from `Jamaica` and cities `Kingston` `Montego-bay` `Ocho-rios` `Port-antonio`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/CodeKingClarke">
				<img src="https://avatars.githubusercontent.com/u/16729206?s=72&u=037cc09d26ecd66f5cee330ad9c8f487b3937b09&v=4" width="24" alt="Avatar of CodeKingClarke"> CodeKingClarke
			</a><br/>
			Hakeem Clarke
		</td>
		<td>Speur Group  </td>
