...
The `public contributions` by users in Jamaica on `2022/2/18 12:24 PM UTC`. This list contains users from `Jamaica` and cities `Kingston` `Montego-bay` `Ocho-rios` `Port-antonio`.
...
<table>
	...
	<tr>
		...
		<td>Software Developer @nordec </td>
		<td>No Twitter Username</td>
		<td>Kingston,ON, Canada</td>
		<td>62</td>
	</tr>
