...
The `public contributions` by users in Namibia on `2022/4/22 6:17 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
