...
The `public contributions` by users in Botswana on `2025/4/12 12:41 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
...
<table>
	...
	<tr>
		<td>198</td>
		<td>
			<a href="https://github.com/Twettytwitchk">
				<img src="https://avatars.githubusercontent.com/u/99083258?s=72&v=4" width="24" alt="Avatar of Twettytwitchk"> Twettytwitchk
			</a><br/>
			Lisa Tautona 
		</td>
		<td>201604106@ub.ac.bw  </td>
		<td>No Twitter Username</td>
		<td>Botswana </td>
		<td>5</td>
	</tr>
