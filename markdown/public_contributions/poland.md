...
The `public contributions` by users in Poland on `2021/10/6 11:20 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
