...
The `public contributions` by users in Poland on `2022/2/1 6:52 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
