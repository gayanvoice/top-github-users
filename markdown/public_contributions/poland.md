...
The `public contributions` by users in Poland on `2021/7/12 1:31 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
