...
The `public contributions` by users in Poland on `2021/8/10 7:30 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
