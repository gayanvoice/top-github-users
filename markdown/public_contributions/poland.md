...
The `public contributions` by users in Poland on `2021/12/20 6:25 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
