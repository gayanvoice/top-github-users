...
The `public contributions` by users in Sweden on `2021/6/15 6:29 AM UTC`. This list contains users from `Sweden` and cities `Stockholm` `Gothenburg` `Uppsala` `Helsingborg`.

There are `136 countries` and `685 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `200 users`  in Sweden. You need at least `190 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/bagder">
				<img src="https://avatars.githubusercontent.com/u/177011?s=72&v=4" width="24" alt="Avatar of bagder"> bagder
			</a><br/>
			Daniel Stenberg
		</td>
		<td>@wolfssl  </td>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/LiveLikeCounter">
				<img src="https://avatars.githubusercontent.com/u/24720382?s=72&u=8e14f00794219ec3c857859d2e7bc7877a236019&v=4" width="24" alt="Avatar of LiveLikeCounter"> LiveLikeCounter
			</a><br/>
			Johan
		</td>
		<td>Interestinate </td>
