...
The `public contributions` by users in Finland on `2021/9/23 1:02 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
