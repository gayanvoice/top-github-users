...
The `public contributions` by users in Finland on `2021/7/10 4:28 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
