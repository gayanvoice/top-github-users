...
The `public contributions` by users in Finland on `2021/7/27 11:22 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
