...
The `public contributions` by users in Finland on `2022/5/1 1:18 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
