...
The `public contributions` by users in Finland on `2021/9/28 6:27 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
