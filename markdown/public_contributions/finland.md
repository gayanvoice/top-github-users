...
The `public contributions` by users in Finland on `2022/6/5 6:23 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
