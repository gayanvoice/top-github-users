...
The `public contributions` by users in Finland on `2025/1/25 1:40 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
