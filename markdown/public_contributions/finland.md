...
The `public contributions` by users in Finland on `2021/8/25 6:27 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
