...
The `public contributions` by users in Finland on `2024/9/28 1:05 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
