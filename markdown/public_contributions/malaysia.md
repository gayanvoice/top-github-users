...
The `public contributions` by users in Malaysia on `2025/9/26 1:10 AM UTC`. This list contains users from `Malaysia` and cities `Kuala-lumpur` `Malacca-city` `Kuching` `Ipoh` `Johor-bahru`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `975 users`  in Malaysia. You need at least `23 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>University Of Science, Malaysia<br/></td>
