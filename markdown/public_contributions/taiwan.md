...
The `public contributions` by users in Taiwan on `2022/6/27 12:35 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
