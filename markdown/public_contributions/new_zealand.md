...
The `public contributions` by users in New Zealand on `2022/6/20 6:51 PM UTC`. This list contains users from `New Zealand` and cities `Auckland` `Wellington` `Christchurch` `Dunedin`.
