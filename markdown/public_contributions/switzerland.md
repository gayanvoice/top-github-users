...
The `public contributions` by users in Switzerland on `2021/6/15 6:33 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
