...
The `public contributions` by users in Switzerland on `2024/1/13 12:18 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
