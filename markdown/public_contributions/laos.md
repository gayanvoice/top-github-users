...
The `public contributions` by users in Laos on `2022/1/29 7:12 PM UTC`. This list contains users from `Laos` and cities `Vientiane`.
...
<table>
	...
	<tr>
		<td>76</td>
		<td>
			<a href="https://github.com/oleksiilihai">
				<img src="https://avatars.githubusercontent.com/u/72308380?s=72&v=4" width="24" alt="Avatar of oleksiilihai"> oleksiilihai
			</a><br/>
			Oleksii Lihai
		</td>
		<td>No Company</td>
