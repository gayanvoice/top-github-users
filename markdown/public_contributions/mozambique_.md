...
The `public contributions` by users in Mozambique  on `2022/1/10 12:42 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
