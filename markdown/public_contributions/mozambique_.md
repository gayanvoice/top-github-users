...
The `public contributions` by users in Mozambique  on `2022/6/20 7:04 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
