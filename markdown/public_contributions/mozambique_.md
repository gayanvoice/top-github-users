...
The `public contributions` by users in Mozambique  on `2022/7/2 7:19 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
