...
The `public contributions` by users in China on `2021/8/18 7:25 PM UTC`. This list contains users from `China` and cities `Beijing` `Shanghai` `Guangzhou` `Shenzhen` `Chongqing` `Chengdu` `Harbin` `Tianjin`.
...
<table>
	...
	<tr>
		...
		<td>Alibaba Group Holding Ltd.<br/></td>
	...
	<tr>
		...
		<td>@tencent </td>
		<td><a href="https://twitter.com/kidhaibara">kidhaibara</a></td>
		<td>Guangzhou, China</td>
		<td>583</td>
	</tr>
	<tr>
