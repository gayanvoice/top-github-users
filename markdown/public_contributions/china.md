...
The `public contributions` by users in China on `2022/3/27 7:15 PM UTC`. This list contains users from `China` and cities `Beijing` `Shanghai` `Guangzhou` `Shenzhen` `Chongqing` `Chengdu` `Harbin` `Tianjin`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `1000 users`  in China. You need at least `578 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>Kiev, Ukraine, Europe, Asia, Earth, USA, Spain, Germany, Italy, China, Kyiv, US</td>
		<td>2698</td>
	</tr>
	<tr>
		<td>23</td>
	...
	<tr>
		...
		<td>@pingcap  </td>
		<td><a href="https://twitter.com/henglonng">henglonng</a></td>
		<td>China</td>
		<td>177</td>
	</tr>
	<tr>
