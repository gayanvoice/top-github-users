...
The `public contributions` by users in China on `2021/8/1 3:23 PM UTC`. This list contains users from `China` and cities `Beijing` `Shanghai` `Guangzhou` `Shenzhen` `Chongqing` `Chengdu` `Harbin` `Tianjin`.

There are `136 countries` and `673 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `1000 users`  in China. You need at least `538 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/lichuang">
				<img src="https://avatars.githubusercontent.com/u/1998569?s=72&u=2f3ffb398ab2cce7849aaa5a22b6c73458f7596e&v=4" width="24" alt="Avatar of lichuang"> lichuang
			</a><br/>
			codedump
		</td>
		<td>No Company</td>
