...
The `public contributions` by users in China on `2025/10/28 12:45 AM UTC`. This list contains users from `China` and cities `Beijing` `Shanghai` `Guangzhou` `Shenzhen` `Chongqing` `Chengdu` `Harbin` `Tianjin`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `932 users`  in China. You need at least `799 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>@apache @antgroup @segmentfault </td>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/supnate">
				<img src="https://avatars.githubusercontent.com/u/481738?s=72&u=cd0deb6fca2f93c1db24c1602c10cef70dce056a&v=4" width="24" alt="Avatar of supnate"> supnate
			</a><br/>
			Nate Wang
		</td>
		<td>Ebay </td>
