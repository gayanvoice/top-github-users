...
The `public contributions` by users in China on `2021/7/9 1:27 PM UTC`. This list contains users from `China` and cities `Beijing` `Shanghai` `Guangzhou` `Shenzhen` `Chongqing` `Chengdu` `Harbin` `Tianjin`.

There are `136 countries` and `673 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `1000 users`  in China. You need at least `534 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>Qianxin </td>
		<td><a href="https://twitter.com/Lucifer">Lucifer</a></td>
		<td>Chengdu,China</td>
		<td>96</td>
	</tr>
	<tr>
