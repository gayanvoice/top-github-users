...
The `public contributions` by users in Bulgaria on `2022/7/9 3:05 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
