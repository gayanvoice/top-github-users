...
The `public contributions` by users in Bulgaria on `2021/8/24 7:23 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
