...
The `public contributions` by users in Bulgaria on `2023/12/19 12:18 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
