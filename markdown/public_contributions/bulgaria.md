...
The `public contributions` by users in Bulgaria on `2021/11/2 1:02 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
