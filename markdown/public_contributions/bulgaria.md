...
The `public contributions` by users in Bulgaria on `2025/6/8 1:22 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
