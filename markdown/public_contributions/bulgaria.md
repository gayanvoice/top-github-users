...
The `public contributions` by users in Bulgaria on `2021/7/20 3:29 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
