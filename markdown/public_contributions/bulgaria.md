...
The `public contributions` by users in Bulgaria on `2021/10/9 11:20 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
