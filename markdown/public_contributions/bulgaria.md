...
The `public contributions` by users in Bulgaria on `2022/6/15 6:46 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
