...
The `public contributions` by users in Saudi Arabia on `2021/6/13 6:11 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.

There are `46 countries` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `100 users`  in Saudi Arabia. You need at least `17 followers` to be on this list.
