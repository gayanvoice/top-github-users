...
The `public contributions` by users in Saudi Arabia on `2022/7/4 6:52 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/devafq">devafq</a></td>
		<td>Riyadh </td>
		<td>2</td>
	</tr>
	<tr>
