...
The `public contributions` by users in Spain on `2021/10/19 1:38 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
