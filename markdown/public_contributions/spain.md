...
The `public contributions` by users in Spain on `2021/6/15 6:16 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

There are `136 countries` and `685 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `200 users`  in Spain. You need at least `225 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>Kornia.org  | Grid<br/>Ai<br/></td>
