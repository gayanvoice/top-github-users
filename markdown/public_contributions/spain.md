...
The `public contributions` by users in Spain on `2022/6/23 7:01 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
