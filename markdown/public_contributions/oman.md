...
The `public contributions` by users in Oman on `2021/10/24 12:27 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `678 users`  in Oman. You need at least `0 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/mahmoodoom">
				<img src="https://avatars.githubusercontent.com/u/92733525?s=72&v=4" width="24" alt="Avatar of mahmoodoom"> mahmoodoom
			</a><br/>
			MaHmood Al-Abri
		</td>
		<td>No Company</td>
