...
The `public contributions` by users in Oman on `2022/7/23 1:13 AM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `832 users`  in Oman. You need at least `0 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>276</td>
		<td>
			<a href="https://github.com/hamzaaw">
				<img src="https://avatars.githubusercontent.com/u/90915422?s=72&v=4" width="24" alt="Avatar of hamzaaw"> hamzaaw
			</a><br/>
			Muhammad Hamza
		</td>
		<td>Reativebrains </td>
