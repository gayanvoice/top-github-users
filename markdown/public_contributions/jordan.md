...
The `public contributions` by users in Jordan on `2024/6/20 12:17 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
