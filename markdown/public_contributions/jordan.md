...
The `public contributions` by users in Jordan on `2024/3/7 1:09 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
