...
The `public contributions` by users in Ecuador on `2021/9/28 1:29 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
