...
The `public contributions` by users in Ecuador on `2022/3/18 6:43 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
