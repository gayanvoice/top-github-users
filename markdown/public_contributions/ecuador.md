...
The `public contributions` by users in Ecuador on `2021/7/4 7:20 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
