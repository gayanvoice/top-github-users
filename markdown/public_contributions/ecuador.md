...
The `public contributions` by users in Ecuador on `2022/3/28 7:03 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
