...
The `public contributions` by users in Ecuador on `2021/9/22 7:19 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
