...
The `public contributions` by users in Ecuador on `2021/11/20 5:21 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
