...
The `public contributions` by users in Ecuador on `2022/2/26 6:40 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
