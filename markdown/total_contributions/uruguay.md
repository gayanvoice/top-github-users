...
The `public contributions` and `private contributions` by users in Uruguay on `2022/6/12 7:05 PM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.
