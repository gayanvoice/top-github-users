...
The `public contributions` and `private contributions` by users in Uruguay on `2021/7/8 2:40 AM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.
