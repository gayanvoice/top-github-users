...
The `public contributions` and `private contributions` by users in Uruguay on `2022/1/13 1:28 PM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.
