...
The `public contributions` and `private contributions` by users in Sudan on `2022/5/19 7:25 AM UTC`. This list contains users from `Sudan` and cities `Khartoum` `Omdurman`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/motabaidris">
				<img src="https://avatars.githubusercontent.com/u/104836690?s=72&v=4" width="24" alt="Avatar of motabaidris"> motabaidris
			</a><br/>
			Mogtaba Idris
		</td>
		<td>No Company</td>
