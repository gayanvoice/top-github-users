...
The `public contributions` and `private contributions` by users in Sudan on `2022/1/12 1:22 PM UTC`. This list contains users from `Sudan` and cities `Khartoum` `Omdurman`.
