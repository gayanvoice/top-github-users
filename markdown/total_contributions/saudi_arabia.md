...
The `public contributions` and `private contributions` by users in Saudi Arabia on `2026/4/18 1:08 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
