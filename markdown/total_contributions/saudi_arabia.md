...
The `public contributions` and `private contributions` by users in Saudi Arabia on `2021/12/4 4:30 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
