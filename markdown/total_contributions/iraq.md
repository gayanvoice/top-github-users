...
The `public contributions` and `private contributions` by users in Iraq on `2021/7/10 5:24 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
