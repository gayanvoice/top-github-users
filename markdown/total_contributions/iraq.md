...
The `public contributions` and `private contributions` by users in Iraq on `2025/3/10 12:38 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
