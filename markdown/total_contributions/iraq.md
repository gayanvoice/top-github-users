...
The `public contributions` and `private contributions` by users in Iraq on `2021/9/23 2:20 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
