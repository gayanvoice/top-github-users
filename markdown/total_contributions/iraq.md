...
The `public contributions` and `private contributions` by users in Iraq on `2022/1/29 6:18 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
