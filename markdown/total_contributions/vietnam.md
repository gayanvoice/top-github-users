...
The `public contributions` and `private contributions` by users in Vietnam on `2024/12/2 12:46 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
