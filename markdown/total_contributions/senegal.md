...
The `public contributions` and `private contributions` by users in Senegal on `2022/5/30 12:28 PM UTC`. This list contains users from `Senegal` and cities `Dakar`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `933 users`  in Senegal. You need at least `0 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>549</td>
		<td>
			<a href="https://github.com/MadouNdiaye">
				<img src="https://avatars.githubusercontent.com/u/64312929?s=72&v=4" width="24" alt="Avatar of MadouNdiaye"> MadouNdiaye
			</a><br/>
			envcarto
		</td>
		<td>Redgis Africa  </td>
