...
The `public contributions` and `private contributions` by users in Senegal on `2022/4/24 7:07 AM UTC`. This list contains users from `Senegal` and cities `Dakar`.
