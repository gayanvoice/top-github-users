...
The `public contributions` and `private contributions` by users in Senegal on `2022/4/13 1:32 PM UTC`. This list contains users from `Senegal` and cities `Dakar`.
