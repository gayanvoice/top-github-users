...
The `public contributions` and `private contributions` by users in Mauritania on `2024/5/20 12:11 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
