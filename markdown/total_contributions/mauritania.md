...
The `public contributions` and `private contributions` by users in Mauritania on `2021/8/3 4:23 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
