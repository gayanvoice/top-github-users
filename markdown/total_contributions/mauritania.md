...
The `public contributions` and `private contributions` by users in Mauritania on `2021/9/30 4:19 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
