...
The `public contributions` and `private contributions` by users in Mauritania on `2021/10/6 12:53 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
