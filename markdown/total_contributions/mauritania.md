...
The `public contributions` and `private contributions` by users in Mauritania on `2021/11/21 7:12 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
