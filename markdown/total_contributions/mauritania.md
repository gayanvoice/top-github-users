...
The `public contributions` and `private contributions` by users in Mauritania on `2021/7/5 9:14 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
