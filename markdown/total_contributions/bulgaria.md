...
The `public contributions` and `private contributions` by users in Bulgaria on `2021/11/13 4:32 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
