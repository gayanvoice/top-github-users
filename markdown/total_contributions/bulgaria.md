...
The `public contributions` and `private contributions` by users in Bulgaria on `2021/6/21 1:39 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/bundyo">
				<img src="https://avatars.githubusercontent.com/u/98318?s=72&u=8cef17969990dfe931d672857cceb9d287a7f2a5&v=4" width="24" alt="Avatar of bundyo"> bundyo
			</a><br/>
			Bundyo (Kamen Bundev)
		</td>
		<td>Telerik </td>
