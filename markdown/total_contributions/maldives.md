...
The `public contributions` and `private contributions` by users in Maldives on `2022/6/8 6:17 AM UTC`. This list contains users from `Maldives` and cities `Malé` `Addu-city`.
