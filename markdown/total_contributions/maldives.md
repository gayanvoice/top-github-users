...
The `public contributions` and `private contributions` by users in Maldives on `2022/2/9 6:15 AM UTC`. This list contains users from `Maldives` and cities `Malé` `Addu-city`.
