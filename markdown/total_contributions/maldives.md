...
The `public contributions` and `private contributions` by users in Maldives on `2022/7/1 7:16 AM UTC`. This list contains users from `Maldives` and cities `Malé` `Addu-city`.
