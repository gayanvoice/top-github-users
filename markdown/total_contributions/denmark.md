...
The `public contributions` and `private contributions` by users in Denmark on `2021/6/22 5:27 AM UTC`. This list contains users from `Denmark` and cities `Copenhagen` `Aarhus` `Aalborg` `Odense` `Esbjerg` `Kolding`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/groenborg">
				<img src="https://avatars.githubusercontent.com/u/5576954?s=72&u=1050fb2a1abd429a6ab2059254a757d80604cc13&v=4" width="24" alt="Avatar of groenborg"> groenborg
			</a><br/>
			Simon Grønborg
		</td>
		<td>Code Is Key </td>
