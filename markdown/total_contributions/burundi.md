...
The `public contributions` and `private contributions` by users in Burundi on `2024/7/14 12:34 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `418 users`  in Burundi. You need at least `0 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>207</td>
		<td>
			<a href="https://github.com/KAMANA-urbaain">
				<img src="https://avatars.githubusercontent.com/u/173337933?s=72&v=4" width="24" alt="Avatar of KAMANA-urbaain"> KAMANA-urbaain
			</a><br/>
			Urbain-Kamana
		</td>
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>BURUNDI-BUJUMBURA-KANYOSHA</td>
		<td>1</td>
		<td>1</td>
	</tr>
	<tr>
