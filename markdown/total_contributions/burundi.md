...
The `public contributions` and `private contributions` by users in Burundi on `2022/1/5 6:14 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `200 users`  in Burundi. You need at least `0 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/poseudo">
				<img src="https://avatars.githubusercontent.com/u/97025521?s=72&v=4" width="24" alt="Avatar of poseudo"> poseudo
			</a><br/>
			MANIRAKIZA Blaise
		</td>
		<td>No Company</td>
