...
The `public contributions` and `private contributions` by users in Burundi on `2024/4/1 12:13 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `406 users`  in Burundi. You need at least `0 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Wilondja243">
				<img src="https://avatars.githubusercontent.com/u/164260676?s=72&v=4" width="24" alt="Avatar of Wilondja243"> Wilondja243
			</a><br/>
			Luckson
		</td>
		<td>No Company</td>
