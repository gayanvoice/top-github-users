...
The `public contributions` and `private contributions` by users in Iran on `2021/7/22 4:26 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
