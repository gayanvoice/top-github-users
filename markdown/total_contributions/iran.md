...
The `public contributions` and `private contributions` by users in Iran on `2022/6/6 6:43 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
