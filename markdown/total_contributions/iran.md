...
The `public contributions` and `private contributions` by users in Iran on `2022/3/20 2:10 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
