...
The `public contributions` and `private contributions` by users in Iran on `2021/8/8 11:18 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
