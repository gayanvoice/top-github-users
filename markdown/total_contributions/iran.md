...
The `public contributions` and `private contributions` by users in Iran on `2024/10/2 12:40 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
