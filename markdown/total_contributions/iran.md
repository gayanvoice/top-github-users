...
The `public contributions` and `private contributions` by users in Iran on `2021/11/9 10:24 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
