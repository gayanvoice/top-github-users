...
The `public contributions` and `private contributions` by users in Iran on `2021/6/22 4:09 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
