...
The `public contributions` and `private contributions` by users in Iran on `2021/10/5 3:22 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
