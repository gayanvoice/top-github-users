...
The `public contributions` and `private contributions` by users in Georgia on `2021/10/16 1:26 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/tamazbagdavadze">
				<img src="https://avatars.githubusercontent.com/u/7658478?s=72&v=4" width="24" alt="Avatar of tamazbagdavadze"> tamazbagdavadze
			</a><br/>
			Tamaz Bagdavadze
		</td>
		<td>No Company</td>
