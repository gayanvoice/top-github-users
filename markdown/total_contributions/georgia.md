...
The `public contributions` and `private contributions` by users in Georgia on `2022/6/28 7:25 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
