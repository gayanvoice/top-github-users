...
The `public contributions` and `private contributions` by users in Georgia on `2021/9/5 7:19 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
...
<table>
	...
	<tr>
		<td>226</td>
		<td>
			<a href="https://github.com/jeffreytram">
				<img src="https://avatars.githubusercontent.com/u/40370693?s=72&v=4" width="24" alt="Avatar of jeffreytram"> jeffreytram
			</a><br/>
			No Name
		</td>
		<td>No Company</td>
