...
The `public contributions` and `private contributions` by users in Georgia on `2024/12/19 12:23 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
...
<table>
	...
	<tr>
		<td>744</td>
		<td>
			<a href="https://github.com/codeclout">
				<img src="https://avatars.githubusercontent.com/u/936085?s=72&u=dd37ef4f42457b1ffd3f1a880048f570d864b015&v=4" width="24" alt="Avatar of codeclout"> codeclout
			</a><br/>
			Brian Duckett
		</td>
		<td>Codeclout Design </td>
		<td>No Twitter Username</td>
		<td>Georgia, USA</td>
		<td>5</td>
		<td>5</td>
