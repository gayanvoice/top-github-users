...
The `public contributions` and `private contributions` by users in Georgia on `2021/10/28 8:25 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/zvlex">zvlex</a></td>
		<td>Tbilisi, Georgia</td>
		<td>3</td>
		<td>71</td>
	</tr>
