...
The `public contributions` and `private contributions` by users in Georgia on `2021/8/8 2:03 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
