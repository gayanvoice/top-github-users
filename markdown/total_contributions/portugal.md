...
The `public contributions` and `private contributions` by users in Portugal on `2021/6/15 5:21 AM UTC`. This list contains users from `Portugal` and cities `Lisbon` `Porto` `Braga` `Coimbra`.
