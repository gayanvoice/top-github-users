...
The `public contributions` and `private contributions` by users in Portugal on `2021/6/24 6:29 AM UTC`. This list contains users from `Portugal` and cities `Lisbon` `Porto` `Braga` `Coimbra`.
