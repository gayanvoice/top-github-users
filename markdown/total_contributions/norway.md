...
The `public contributions` and `private contributions` by users in Norway on `2021/10/18 12:37 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
