...
The `public contributions` and `private contributions` by users in Norway on `2022/5/29 1:11 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
