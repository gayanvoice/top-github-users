...
The `public contributions` and `private contributions` by users in Norway on `2022/3/2 6:24 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
