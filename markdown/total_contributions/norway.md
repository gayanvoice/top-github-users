...
The `public contributions` and `private contributions` by users in Norway on `2021/7/6 12:38 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
