...
The `public contributions` and `private contributions` by users in Norway on `2021/8/15 6:26 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
