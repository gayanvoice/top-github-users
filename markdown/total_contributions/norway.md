...
The `public contributions` and `private contributions` by users in Norway on `2022/5/5 6:25 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
