...
The `public contributions` and `private contributions` by users in Norway on `2022/6/21 3:20 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
