...
The `public contributions` and `private contributions` by users in Norway on `2021/11/16 4:33 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
