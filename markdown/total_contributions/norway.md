...
The `public contributions` and `private contributions` by users in Norway on `2021/10/6 3:30 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
