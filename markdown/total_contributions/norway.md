...
The `public contributions` and `private contributions` by users in Norway on `2021/6/18 6:28 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
