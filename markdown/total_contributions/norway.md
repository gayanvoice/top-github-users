...
The `public contributions` and `private contributions` by users in Norway on `2021/9/25 2:07 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
