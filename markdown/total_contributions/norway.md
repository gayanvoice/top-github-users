...
The `public contributions` and `private contributions` by users in Norway on `2021/9/19 6:26 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
