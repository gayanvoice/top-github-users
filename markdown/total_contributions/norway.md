...
The `public contributions` and `private contributions` by users in Norway on `2021/12/9 12:26 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
