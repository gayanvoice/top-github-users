...
The `public contributions` and `private contributions` by users in Norway on `2021/8/9 11:25 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
