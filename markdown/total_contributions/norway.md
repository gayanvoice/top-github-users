...
The `public contributions` and `private contributions` by users in Norway on `2021/7/23 5:31 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
