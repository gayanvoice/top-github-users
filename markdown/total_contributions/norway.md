...
The `public contributions` and `private contributions` by users in Norway on `2021/9/30 7:22 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
