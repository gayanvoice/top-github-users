...
The `public contributions` and `private contributions` by users in Norway on `2021/7/17 9:23 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
