...
The `public contributions` and `private contributions` by users in Zimbabwe on `2022/3/5 7:00 PM UTC`. This list contains users from `Zimbabwe` and cities `Harare` `Bulawayo`.
