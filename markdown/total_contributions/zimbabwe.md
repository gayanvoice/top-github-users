...
The `public contributions` and `private contributions` by users in Zimbabwe on `2021/10/8 2:20 PM UTC`. This list contains users from `Zimbabwe` and cities `Harare` `Bulawayo`.
