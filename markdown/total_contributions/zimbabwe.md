...
The `public contributions` and `private contributions` by users in Zimbabwe on `2022/6/2 6:22 AM UTC`. This list contains users from `Zimbabwe` and cities `Harare` `Bulawayo`.
