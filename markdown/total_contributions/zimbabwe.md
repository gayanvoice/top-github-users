...
The `public contributions` and `private contributions` by users in Zimbabwe on `2022/2/13 6:58 PM UTC`. This list contains users from `Zimbabwe` and cities `Harare` `Bulawayo`.
