...
The `public contributions` and `private contributions` by users in Zimbabwe on `2022/2/23 7:00 PM UTC`. This list contains users from `Zimbabwe` and cities `Harare` `Bulawayo`.
