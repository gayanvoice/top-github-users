...
The `public contributions` and `private contributions` by users in Zimbabwe on `2022/3/25 7:20 PM UTC`. This list contains users from `Zimbabwe` and cities `Harare` `Bulawayo`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/takumade">
				<img src="https://avatars.githubusercontent.com/u/42911769?s=72&u=fee1e28ac4da26451da1a7295a6796ad4cefa2af&v=4" width="24" alt="Avatar of takumade"> takumade
			</a><br/>
			Takunda Madechangu
		</td>
