...
The `public contributions` and `private contributions` by users in Botswana on `2021/9/16 4:21 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
