...
The `public contributions` and `private contributions` by users in Botswana on `2022/2/25 6:53 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
...
<table>
	...
	<tr>
		<td>223</td>
		<td>
			<a href="https://github.com/agroasia">
				<img src="https://avatars.githubusercontent.com/u/100027638?s=72&v=4" width="24" alt="Avatar of agroasia"> agroasia
			</a><br/>
			Massey Ferguson Tractors
		</td>
		<td>Massey Ferguson Tractors </td>
		<td>No Twitter Username</td>
		<td>Botswana</td>
		<td>1</td>
		<td>1</td>
