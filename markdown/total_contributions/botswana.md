...
The `public contributions` and `private contributions` by users in Botswana on `2021/7/3 11:14 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
