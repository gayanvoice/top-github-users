...
The `public contributions` and `private contributions` by users in Botswana on `2021/10/21 7:18 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
