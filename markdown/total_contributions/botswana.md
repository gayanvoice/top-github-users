...
The `public contributions` and `private contributions` by users in Botswana on `2021/8/1 5:15 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
