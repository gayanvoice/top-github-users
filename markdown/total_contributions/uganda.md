...
The `public contributions` and `private contributions` by users in Uganda on `2022/4/4 12:32 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
