...
The `public contributions` and `private contributions` by users in Uganda on `2022/5/20 6:50 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.
