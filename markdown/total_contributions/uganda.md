...
The `public contributions` and `private contributions` by users in Uganda on `2022/2/23 6:21 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.
