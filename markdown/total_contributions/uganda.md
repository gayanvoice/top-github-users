...
The `public contributions` and `private contributions` by users in Uganda on `2022/6/24 6:23 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.
