...
The `public contributions` and `private contributions` by users in Uganda on `2021/6/15 6:57 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.
