...
The `public contributions` and `private contributions` by users in Uganda on `2022/6/12 12:25 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
