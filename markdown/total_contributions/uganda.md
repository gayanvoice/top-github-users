...
The `public contributions` and `private contributions` by users in Uganda on `2022/4/15 2:58 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.
