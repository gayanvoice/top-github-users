...
The `public contributions` and `private contributions` by users in Malta on `2021/7/17 5:19 AM UTC`. This list contains users from `Malta` and cities `Valletta` `Sliema` `Saint-pauls-bay`.
