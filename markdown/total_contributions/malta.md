...
The `public contributions` and `private contributions` by users in Malta on `2021/6/18 8:46 AM UTC`. This list contains users from `Malta` and cities `Valletta` `Sliema` `Victoria` `Saint-pauls-bay`.
