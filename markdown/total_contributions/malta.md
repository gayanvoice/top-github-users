...
The `public contributions` and `private contributions` by users in Malta on `2021/7/11 1:24 PM UTC`. This list contains users from `Malta` and cities `Valletta` `Sliema` `Saint-pauls-bay`.
