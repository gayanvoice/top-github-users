...
The `public contributions` and `private contributions` by users in Malta on `2022/7/1 1:13 PM UTC`. This list contains users from `Malta` and cities `Valletta` `Sliema` `Saint-pauls-bay`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/DamainRamsajan">
				<img src="https://avatars.githubusercontent.com/u/75503131?s=72&u=a2de25aa555f6e0ecbe74d76aa5f34e3ecccba5d&v=4" width="24" alt="Avatar of DamainRamsajan"> DamainRamsajan
			</a><br/>
