...
The `public contributions` and `private contributions` by users in Malta on `2021/11/10 6:25 AM UTC`. This list contains users from `Malta` and cities `Valletta` `Sliema` `Saint-pauls-bay`.
