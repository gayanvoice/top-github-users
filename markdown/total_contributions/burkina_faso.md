...
The `public contributions` and `private contributions` by users in Burkina Faso on `2022/2/25 12:18 PM UTC`. This list contains users from `Burkina Faso` and cities `Ouagadougou` `Bobo-dioulasso` `Koudougou` `Banfora` `Ouahigouya`.
