...
The `public contributions` and `private contributions` by users in Ukraine on `2022/6/24 6:46 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
