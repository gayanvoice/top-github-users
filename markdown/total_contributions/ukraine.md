...
The `public contributions` and `private contributions` by users in Ukraine on `2021/6/20 5:22 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
