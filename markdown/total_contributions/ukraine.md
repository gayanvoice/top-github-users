...
The `public contributions` and `private contributions` by users in Ukraine on `2022/5/20 7:03 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
