...
The `public contributions` and `private contributions` by users in Ukraine on `2026/1/16 12:25 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
