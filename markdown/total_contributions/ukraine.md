...
The `public contributions` and `private contributions` by users in Ukraine on `2022/6/12 12:57 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
