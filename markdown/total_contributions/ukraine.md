...
The `public contributions` and `private contributions` by users in Ukraine on `2021/6/17 1:45 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
