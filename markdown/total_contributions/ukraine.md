...
The `public contributions` and `private contributions` by users in Ukraine on `2022/1/13 7:01 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
