...
The `public contributions` and `private contributions` by users in Ukraine on `2025/1/10 12:44 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
