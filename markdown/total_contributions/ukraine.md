...
The `public contributions` and `private contributions` by users in Ukraine on `2022/2/23 6:39 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
