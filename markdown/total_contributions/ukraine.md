...
The `public contributions` and `private contributions` by users in Ukraine on `2022/2/13 6:38 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
