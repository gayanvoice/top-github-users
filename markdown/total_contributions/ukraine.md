...
The `public contributions` and `private contributions` by users in Ukraine on `2022/12/21 2:06 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/krekoten">
				<img src="https://avatars.githubusercontent.com/u/150485?s=72&u=bcbdf0c92b074cf4d8717170c64aeea8064c77df&v=4" width="24" alt="Avatar of krekoten"> krekoten
			</a><br/>
			Marian Krekoten
		</td>
		<td>No Company</td>
