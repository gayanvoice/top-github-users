...
The `public contributions` and `private contributions` by users in Ukraine on `2022/7/6 6:47 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
