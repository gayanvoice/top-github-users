...
The `public contributions` and `private contributions` by users in Angola on `2021/6/17 7:54 PM UTC`. This list contains users from `Angola` and cities `Luanda` `Cabinda ` `Huambo` `Lubango ` `Kuito` `Malanje ` `Lobito` `Benguela`.
...
<table>
	...
	<tr>
		<td>197</td>
		<td>
			<a href="https://github.com/OsvaldoFernando">
				<img src="https://avatars.githubusercontent.com/u/36325514?s=72&u=d931d7d3af4b30e44da660a8c41ad3e6b84d1f4e&v=4" width="24" alt="Avatar of OsvaldoFernando"> OsvaldoFernando
			</a><br/>
			Osvaldo Queta
		</td>
		<td>No Company</td>
