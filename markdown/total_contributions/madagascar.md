...
The `public contributions` and `private contributions` by users in Madagascar on `2024/5/18 12:54 AM UTC`. This list contains users from `Madagascar` and cities `Antananarivo` `Toamasina` `Mahajanga` `Antsirabe`.
