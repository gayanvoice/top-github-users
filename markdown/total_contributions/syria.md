...
The `public contributions` and `private contributions` by users in Syria on `2021/6/19 10:20 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
