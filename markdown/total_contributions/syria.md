...
The `public contributions` and `private contributions` by users in Syria on `2024/9/12 1:35 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
