...
The `public contributions` and `private contributions` by users in Finland on `2021/9/5 5:28 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
