...
The `public contributions` and `private contributions` by users in Finland on `2021/10/10 11:21 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
