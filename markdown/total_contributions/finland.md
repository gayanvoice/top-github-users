...
The `public contributions` and `private contributions` by users in Finland on `2021/7/4 12:31 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
