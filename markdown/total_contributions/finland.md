...
The `public contributions` and `private contributions` by users in Finland on `2026/8/28 8:50 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
