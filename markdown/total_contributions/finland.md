...
The `public contributions` and `private contributions` by users in Finland on `2021/11/20 10:26 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
