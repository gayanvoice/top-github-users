...
The `public contributions` and `private contributions` by users in Finland on `2024/4/6 12:53 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
