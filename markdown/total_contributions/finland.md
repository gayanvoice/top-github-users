...
The `public contributions` and `private contributions` by users in Finland on `2022/3/9 6:25 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
