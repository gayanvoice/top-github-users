...
The `public contributions` and `private contributions` by users in Ireland on `2022/5/13 7:21 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/irishtechie">
				<img src="https://avatars.githubusercontent.com/u/4664690?s=72&v=4" width="24" alt="Avatar of irishtechie"> irishtechie
			</a><br/>
			Karl Cooke
		</td>
		<td>Intercept B.v. </td>
