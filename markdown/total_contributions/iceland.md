...
The `public contributions` and `private contributions` by users in Iceland on `2021/9/17 3:23 PM UTC`. This list contains users from `Iceland` and cities `Reykjavík` `Hafnarfjordur` `Kópavogur` `Reykjanesbær` `Akureyri`.
