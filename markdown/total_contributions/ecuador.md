...
The `public contributions` and `private contributions` by users in Ecuador on `2021/7/21 10:24 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
