...
The `public contributions` and `private contributions` by users in Ecuador on `2021/9/5 12:30 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
