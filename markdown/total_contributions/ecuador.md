...
The `public contributions` and `private contributions` by users in Ecuador on `2021/7/27 6:26 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
