...
The `public contributions` and `private contributions` by users in Taiwan on `2024/12/13 1:13 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
