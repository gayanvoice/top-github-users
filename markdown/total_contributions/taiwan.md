...
The `public contributions` and `private contributions` by users in Taiwan on `2022/6/16 3:09 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
