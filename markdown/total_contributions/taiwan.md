...
The `public contributions` and `private contributions` by users in Taiwan on `2022/2/5 7:20 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
