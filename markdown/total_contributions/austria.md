...
The `public contributions` and `private contributions` by users in Austria on `2021/9/27 7:24 AM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/herber">
				<img src="https://avatars.githubusercontent.com/u/22559657?s=72&u=e73387a9cf197ff4f47b09cdf64a23c7a6cf8ebf&v=4" width="24" alt="Avatar of herber"> herber
			</a><br/>
			Tobias Herber
		</td>
		<td>@varld  </td>
