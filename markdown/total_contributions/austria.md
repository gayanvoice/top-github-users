...
The `public contributions` and `private contributions` by users in Austria on `2021/10/3 3:24 AM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Advill">
				<img src="https://avatars.githubusercontent.com/u/8991257?s=72&u=a243e69e49e30359751bcc8a7e06bae154947758&v=4" width="24" alt="Avatar of Advill"> Advill
			</a><br/>
			Michael McGloin
		</td>
