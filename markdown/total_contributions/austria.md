...
The `public contributions` and `private contributions` by users in Austria on `2021/12/13 1:22 PM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/rfc2822">
				<img src="https://avatars.githubusercontent.com/u/156167?s=72&u=6e2bd8b5fc7143bd6fbc64158fd87acbd0836ab7&v=4" width="24" alt="Avatar of rfc2822"> rfc2822
			</a><br/>
			Ricki Hirner
		</td>
		<td>@bitfireat </td>
