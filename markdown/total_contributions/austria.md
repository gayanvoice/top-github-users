...
The `public contributions` and `private contributions` by users in Austria on `2022/1/25 1:17 PM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `1000 users`  in Austria. You need at least `26 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/dominic-miglar">
				<img src="https://avatars.githubusercontent.com/u/962116?s=72&u=72cc41ac2d138dbd3f69a46c58864f68d20c0bb6&v=4" width="24" alt="Avatar of dominic-miglar"> dominic-miglar
			</a><br/>
			Dominic Miglar
		</td>
		<td>@bitmovin </td>
