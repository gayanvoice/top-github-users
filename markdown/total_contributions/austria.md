...
The `public contributions` and `private contributions` by users in Austria on `2021/12/6 9:26 AM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/pinguinosod">
				<img src="https://avatars.githubusercontent.com/u/28690088?s=72&u=59642284a9aac88028c1a2ee42ce12ed8986ca5f&v=4" width="24" alt="Avatar of pinguinosod"> pinguinosod
			</a><br/>
			David Cautin
		</td>
		<td>No Company</td>
