...
The `public contributions` and `private contributions` by users in Austria on `2021/9/4 6:26 AM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.
...
<table>
	...
	<tr>
		<td>653</td>
		<td>
			<a href="https://github.com/gkralik">
				<img src="https://avatars.githubusercontent.com/u/4949303?s=72&u=c0690cf133d0baf92769e8464debe14623583336&v=4" width="24" alt="Avatar of gkralik"> gkralik
			</a><br/>
			Gregor Kralik
		</td>
		<td>No Company</td>
