...
The `public contributions` and `private contributions` by users in Austria on `2022/5/9 7:23 AM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/thatcluda">
				<img src="https://avatars.githubusercontent.com/u/83172201?s=72&u=13644585e81c9236508362d388ecdc191cbb0cba&v=4" width="24" alt="Avatar of thatcluda"> thatcluda
			</a><br/>
			alexa
		</td>
		<td>No Company</td>
