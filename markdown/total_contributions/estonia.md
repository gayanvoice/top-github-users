...
The `public contributions` and `private contributions` by users in Estonia on `2021/8/13 4:36 PM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.
