...
The `public contributions` and `private contributions` by users in Estonia on `2021/12/16 6:22 AM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.
