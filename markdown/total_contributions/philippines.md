...
The `public contributions` and `private contributions` by users in Philippines on `2022/3/13 12:51 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
