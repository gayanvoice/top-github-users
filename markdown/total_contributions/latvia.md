...
The `public contributions` and `private contributions` by users in Latvia on `2021/11/27 4:27 AM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
...
<table>
	...
	<tr>
		<td>388</td>
		<td>
			<a href="https://github.com/minekrafters">
				<img src="https://avatars.githubusercontent.com/u/42009476?s=72&v=4" width="24" alt="Avatar of minekrafters"> minekrafters
			</a><br/>
			Niks
		</td>
		<td>No Company</td>
