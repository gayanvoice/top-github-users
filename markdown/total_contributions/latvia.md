...
The `public contributions` and `private contributions` by users in Latvia on `2025/2/1 1:10 AM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
