...
The `public contributions` and `private contributions` by users in Latvia on `2022/6/19 3:21 AM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/cliquant">
				<img src="https://avatars.githubusercontent.com/u/42009476?s=72&u=03b4571fc9ee5ebeebaee7660711be614867f39e&v=4" width="24" alt="Avatar of cliquant"> cliquant
			</a><br/>
			Niks
		</td>
		<td>Street </td>
