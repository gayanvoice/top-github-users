...
The `public contributions` and `private contributions` by users in Latvia on `2022/4/10 12:58 PM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
...
<table>
	...
	<tr>
		...
		<td>Automation Engineer - Pen<br/>Tester<br/></td>
		<td>No Twitter Username</td>
		<td>Latvia, Riga</td>
		<td>33</td>
		<td>33</td>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/JohnHNewland">
				<img src="https://avatars.githubusercontent.com/u/55283237?s=72&v=4" width="24" alt="Avatar of JohnHNewland"> JohnHNewland
			</a><br/>
			JohnNewland
		</td>
		<td>Rv1g </td>
