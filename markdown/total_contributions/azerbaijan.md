...
The `public contributions` and `private contributions` by users in Azerbaijan on `2022/6/14 7:02 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
