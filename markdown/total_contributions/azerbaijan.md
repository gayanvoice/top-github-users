...
The `public contributions` and `private contributions` by users in Azerbaijan on `2022/6/25 6:56 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
