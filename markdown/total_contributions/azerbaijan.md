...
The `public contributions` and `private contributions` by users in Azerbaijan on `2021/6/13 3:48 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
