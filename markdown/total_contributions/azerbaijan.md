...
The `public contributions` and `private contributions` by users in Azerbaijan on `2024/5/3 12:17 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
