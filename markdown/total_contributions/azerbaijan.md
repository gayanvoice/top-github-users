...
The `public contributions` and `private contributions` by users in Azerbaijan on `2024/8/15 12:35 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
