...
The `public contributions` and `private contributions` by users in Azerbaijan on `2024/7/11 12:18 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
