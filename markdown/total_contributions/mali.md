...
The `public contributions` and `private contributions` by users in Mali on `2021/11/10 5:14 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
