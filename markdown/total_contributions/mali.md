...
The `public contributions` and `private contributions` by users in Mali on `2022/4/11 12:53 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
