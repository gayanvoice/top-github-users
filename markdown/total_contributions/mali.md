...
The `public contributions` and `private contributions` by users in Mali on `2021/7/5 7:12 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
