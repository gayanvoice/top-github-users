...
The `public contributions` and `private contributions` by users in Mali on `2022/3/1 12:19 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
