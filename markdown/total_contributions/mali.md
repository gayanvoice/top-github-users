...
The `public contributions` and `private contributions` by users in Mali on `2022/1/20 6:35 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
