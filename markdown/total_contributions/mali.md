...
The `public contributions` and `private contributions` by users in Mali on `2021/9/7 1:55 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
