...
The `public contributions` and `private contributions` by users in Mali on `2025/11/13 12:43 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
