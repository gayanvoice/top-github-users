...
The `public contributions` and `private contributions` by users in Mali on `2021/6/18 8:14 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
