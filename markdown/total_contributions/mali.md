...
The `public contributions` and `private contributions` by users in Mali on `2022/6/19 12:54 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
