...
The `public contributions` and `private contributions` by users in Mali on `2022/6/8 6:38 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
