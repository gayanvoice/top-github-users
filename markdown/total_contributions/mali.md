...
The `public contributions` and `private contributions` by users in Mali on `2021/8/20 5:20 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
