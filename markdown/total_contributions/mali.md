...
The `public contributions` and `private contributions` by users in Mali on `2022/2/19 12:16 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
