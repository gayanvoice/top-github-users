...
The `public contributions` and `private contributions` by users in Mali on `2021/12/3 8:20 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
