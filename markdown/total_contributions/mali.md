...
The `public contributions` and `private contributions` by users in Mali on `2021/12/8 12:55 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
