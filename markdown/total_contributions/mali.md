...
The `public contributions` and `private contributions` by users in Mali on `2021/11/21 5:21 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
