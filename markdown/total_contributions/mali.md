...
The `public contributions` and `private contributions` by users in Mali on `2021/6/30 2:03 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
