...
The `public contributions` and `private contributions` by users in Nigeria on `2025/11/18 1:16 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
