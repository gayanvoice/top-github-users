...
The `public contributions` and `private contributions` by users in Nigeria on `2022/1/31 1:12 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
