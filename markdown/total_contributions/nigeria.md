...
The `public contributions` and `private contributions` by users in Nigeria on `2021/12/9 7:01 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
