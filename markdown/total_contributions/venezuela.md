...
The `public contributions` and `private contributions` by users in Venezuela on `2021/6/15 8:29 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

There are `136 countries` and `685 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `200 users`  in Venezuela. You need at least `16 followers` to be on this list.
