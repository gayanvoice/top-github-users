...
The `public contributions` and `private contributions` by users in Ghana on `2022/5/25 6:52 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
