...
The `public contributions` and `private contributions` by users in Russia on `2021/9/13 11:24 PM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
...
<table>
	...
	<tr>
		<td>331</td>
		<td>
			<a href="https://github.com/hcodes">
				<img src="https://avatars.githubusercontent.com/u/157520?s=72&v=4" width="24" alt="Avatar of hcodes"> hcodes
			</a><br/>
			Denis Seleznev
		</td>
		<td>No Company</td>
