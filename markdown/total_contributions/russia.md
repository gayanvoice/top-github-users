...
The `public contributions` and `private contributions` by users in Russia on `2021/11/11 10:31 AM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/King-Mufasa">
				<img src="https://avatars.githubusercontent.com/u/53654089?s=72&u=1040d5d83dfde2629500056d15fcd6a1efde94b8&v=4" width="24" alt="Avatar of King-Mufasa"> King-Mufasa
			</a><br/>
			Mufasa 
		</td>
		<td>Gs </td>
