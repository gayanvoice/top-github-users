...
The `public contributions` and `private contributions` by users in Russia on `2021/9/8 6:26 AM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
...
<table>
	...
	<tr>
		...
		<td>@mvximenko </td>
		<td><a href="https://twitter.com/mvximenko">mvximenko</a></td>
	...
	<tr>
		...
		<td>@evilmartians  </td>
		<td><a href="https://twitter.com/madyankin">madyankin</a></td>
		<td>Moscow, Russia</td>
		<td>141</td>
		<td>141</td>
	</tr>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/ae0f">
				<img src="https://avatars.githubusercontent.com/u/547167?s=72&u=c8f4a28a41c7578a3cf935eef65fe7697599c493&v=4" width="24" alt="Avatar of ae0f"> ae0f
			</a><br/>
			Alexey
		</td>
		<td>No Company</td>
