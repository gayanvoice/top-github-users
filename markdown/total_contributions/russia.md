...
The `public contributions` and `private contributions` by users in Russia on `2022/1/22 7:19 AM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
...
<table>
	...
	<tr>
		...
		<td>@torrent-proxy @teacher-army </td>
		<td>No Twitter Username</td>
		<td>St.Petersburg, Russia</td>
		<td>357</td>
		<td>606</td>
