...
The `public contributions` and `private contributions` by users in Russia on `2021/11/17 4:29 AM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/solelychloe">
				<img src="https://avatars.githubusercontent.com/u/22654782?s=72&u=6e0c06d3e601912cd36b773681f0d6b5aaba9389&v=4" width="24" alt="Avatar of solelychloe"> solelychloe
			</a><br/>
			Chloe
		</td>
		<td>@jiktim </td>
