...
The `public contributions` and `private contributions` by users in Russia on `2021/8/4 7:27 PM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/KvanTTT">
				<img src="https://avatars.githubusercontent.com/u/1150330?s=72&u=f51772ab35b8aac729fec562f7d93fdebf617c1b&v=4" width="24" alt="Avatar of KvanTTT"> KvanTTT
			</a><br/>
			Ivan Kochurkin
		</td>
		<td>@jetbrains </td>
