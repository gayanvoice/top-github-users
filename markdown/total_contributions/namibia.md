...
The `public contributions` and `private contributions` by users in Namibia on `2021/7/17 3:19 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
