...
The `public contributions` and `private contributions` by users in Namibia on `2022/5/16 6:18 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Ndafohamba">
				<img src="https://avatars.githubusercontent.com/u/105390351?s=72&v=4" width="24" alt="Avatar of Ndafohamba"> Ndafohamba
			</a><br/>
			No Name
		</td>
