...
The `public contributions` and `private contributions` by users in Namibia on `2021/7/6 6:21 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

There are `136 countries` and `673 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `442 users`  in Namibia. You need at least `0 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td> Fnb Namibia </td>
		<td><a href="https://twitter.com/madjarov42">madjarov42</a></td>
		<td>Namibia</td>
		<td>1</td>
		<td>1</td>
	</tr>
