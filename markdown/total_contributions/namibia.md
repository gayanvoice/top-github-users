...
The `public contributions` and `private contributions` by users in Namibia on `2022/7/2 12:55 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
...
<table>
	...
	<tr>
		<td>23</td>
		<td>
			<a href="https://github.com/eslunar">
				<img src="https://avatars.githubusercontent.com/u/76456024?s=72&u=809aa977afc40ce8f043c7b6363c54df94cc30a4&v=4" width="24" alt="Avatar of eslunar"> eslunar
			</a><br/>
			Faizel Garoeb
		</td>
		<td>Eslunar </td>
