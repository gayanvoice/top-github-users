...
The `public contributions` and `private contributions` by users in Namibia on `2021/9/7 12:25 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

There are `137 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `460 users`  in Namibia. You need at least `0 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>201</td>
		<td>
			<a href="https://github.com/Believe010">
				<img src="https://avatars.githubusercontent.com/u/74560857?s=72&v=4" width="24" alt="Avatar of Believe010"> Believe010
			</a><br/>
			Andreas Sipeta
		</td>
		<td>Muhoko </td>
		<td><a href="https://twitter.com/DrBelieve">DrBelieve</a></td>
		<td>Windhoek</td>
		<td>1</td>
		<td>1</td>
	</tr>
