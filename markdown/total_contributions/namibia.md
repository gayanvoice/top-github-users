...
The `public contributions` and `private contributions` by users in Namibia on `2021/8/4 2:02 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

There are `136 countries` and `673 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `451 users`  in Namibia. You need at least `0 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Matiastomas">
				<img src="https://avatars.githubusercontent.com/u/16385746?s=72&u=01a20a9783a5583dc481eea785f5cc1ccc8267f4&v=4" width="24" alt="Avatar of Matiastomas"> Matiastomas
			</a><br/>
			Matias Tomás
		</td>
		<td>No Company</td>
	...
	<tr>
		...
		<td>Totisoft </td>
		<td><a href="https://twitter.com/totisoft">totisoft</a></td>
		<td>Namibia</td>
		<td>1</td>
		<td>1</td>
	</tr>
