...
The `public contributions` and `private contributions` by users in Namibia on `2021/10/18 6:21 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
