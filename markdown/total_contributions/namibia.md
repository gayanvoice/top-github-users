...
The `public contributions` and `private contributions` by users in Namibia on `2021/9/13 5:16 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
