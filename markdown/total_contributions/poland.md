...
The `public contributions` and `private contributions` by users in Poland on `2021/9/2 8:28 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
