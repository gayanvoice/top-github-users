...
The `public contributions` and `private contributions` by users in Poland on `2021/9/8 2:39 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
