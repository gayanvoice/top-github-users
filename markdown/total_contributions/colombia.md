...
The `public contributions` and `private contributions` by users in Colombia on `2021/12/15 7:00 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
