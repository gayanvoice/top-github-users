...
The `public contributions` and `private contributions` by users in Albania on `2021/9/27 12:55 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
