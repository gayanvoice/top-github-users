...
The `public contributions` and `private contributions` by users in Albania on `2022/3/16 12:57 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
