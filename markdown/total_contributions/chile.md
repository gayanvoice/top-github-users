...
The `public contributions` and `private contributions` by users in Chile on `2025/4/15 1:13 AM UTC`. This list contains users from `Chile` and cities `Santiago` `Valparaíso` `Viña-del-mar` `Arica` `Temuco` `Concepcion` `Puerto-montt`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/marcelocampanelli">
				<img src="https://avatars.githubusercontent.com/u/54248666?s=72&u=ce1f39cf635deacdedc554f26e8f5daf49731a2e&v=4" width="24" alt="Avatar of marcelocampanelli"> marcelocampanelli
			</a><br/>
			Marcelo Campanelli
		</td>
		<td>No Company</td>
