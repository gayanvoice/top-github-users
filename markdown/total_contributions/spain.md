...
The `public contributions` and `private contributions` by users in Spain on `2021/9/20 6:29 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
