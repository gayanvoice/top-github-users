...
The `public contributions` and `private contributions` by users in Spain on `2021/8/28 6:27 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
