...
The `public contributions` and `private contributions` by users in Spain on `2021/8/11 2:05 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
