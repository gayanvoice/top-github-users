...
The `public contributions` and `private contributions` by users in Spain on `2023/8/27 12:18 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
