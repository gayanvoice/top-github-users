...
The `public contributions` and `private contributions` by users in Spain on `2021/9/14 11:24 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
