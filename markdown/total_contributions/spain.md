...
The `public contributions` and `private contributions` by users in Spain on `2021/7/24 4:31 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
