...
The `public contributions` and `private contributions` by users in Moldova on `2021/12/19 6:19 AM UTC`. This list contains users from `Moldova` and cities `Chișinău` `Tiraspol`.
...
<table>
	...
	<tr>
		...
		<td>Business Logic ( 1c<br/>Programmer)<br/></td>
		<td>No Twitter Username</td>
		<td>Moldova, Chisinau</td>
		<td>31</td>
		<td>31</td>
