...
The `public contributions` and `private contributions` by users in Jordan on `2024/10/4 12:19 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
