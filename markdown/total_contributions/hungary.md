...
The `public contributions` and `private contributions` by users in Hungary on `2021/11/15 1:00 AM UTC`. This list contains users from `Hungary` and cities `Budapest` `Debrecen` `Szeged` `Miskolc` `Pécs` `Győr`.
