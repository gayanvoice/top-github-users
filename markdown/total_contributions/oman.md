...
The `public contributions` and `private contributions` by users in Oman on `2021/9/13 12:29 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
