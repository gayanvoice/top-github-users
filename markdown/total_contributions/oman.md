...
The `public contributions` and `private contributions` by users in Oman on `2021/10/30 7:19 AM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
