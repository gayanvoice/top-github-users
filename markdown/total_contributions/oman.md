...
The `public contributions` and `private contributions` by users in Oman on `2021/10/18 1:26 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
