...
The `public contributions` and `private contributions` by users in Oman on `2021/9/30 8:20 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
