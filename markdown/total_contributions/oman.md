...
The `public contributions` and `private contributions` by users in Oman on `2021/8/27 7:18 AM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
