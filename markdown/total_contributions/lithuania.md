...
The `public contributions` and `private contributions` by users in Lithuania on `2021/6/18 5:48 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
...
<table>
	...
	<tr>
		<td>75</td>
		<td>
			<a href="https://github.com/ex13">
				<img src="https://avatars.githubusercontent.com/u/3922808?s=72&u=6efb29d2cda6319c00fcccdd941307e99f3d7f79&v=4" width="24" alt="Avatar of ex13"> ex13
			</a><br/>
			Jevgenij Podskokov
		</td>
