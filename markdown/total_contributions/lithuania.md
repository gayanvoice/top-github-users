...
The `public contributions` and `private contributions` by users in Lithuania on `2021/11/15 5:33 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
