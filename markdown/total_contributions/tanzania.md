...
The `public contributions` and `private contributions` by users in Tanzania on `2026/1/14 12:52 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
