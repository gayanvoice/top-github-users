...
The `public contributions` and `private contributions` by users in Montenegro on `2022/4/1 2:58 AM UTC`. This list contains users from `Montenegro` and cities `Podgorica` `Nikšić`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `686 users`  in Montenegro. You need at least `0 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>393</td>
		<td>
			<a href="https://github.com/FilipInfmk">
				<img src="https://avatars.githubusercontent.com/u/102732176?s=72&u=71295e0bece192ed0923aa93a7c1f7368e5d45cb&v=4" width="24" alt="Avatar of FilipInfmk"> FilipInfmk
			</a><br/>
			No Name
		</td>
		<td>Infinum-montenegro </td>
		<td>No Twitter Username</td>
		<td>Podgorica</td>
		<td>1</td>
		<td>1</td>
