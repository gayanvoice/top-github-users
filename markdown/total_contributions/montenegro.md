...
The `public contributions` and `private contributions` by users in Montenegro on `2021/8/21 12:49 AM UTC`. This list contains users from `Montenegro` and cities `Podgorica` `Nikšić`.

There are `136 countries` and `673 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `571 users`  in Montenegro. You need at least `0 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/dervanovicaisa">
				<img src="https://avatars.githubusercontent.com/u/59751382?s=72&u=e3d2ac6177df918affab757c92537d16d48772c4&v=4" width="24" alt="Avatar of dervanovicaisa"> dervanovicaisa
			</a><br/>
			Aiša Dervanović
		</td>
		<td>@qqriq-team  </td>
